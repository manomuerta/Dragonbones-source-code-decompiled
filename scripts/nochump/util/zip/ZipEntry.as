package nochump.util.zip
{
   ...
   public class ZipEntry
   {
      ...
      {
         var _loc1_:Date = new Date((this.dostime >> 25 & 0x7F) + 1980,(this.dostime >> 21 & 0x0F) - 1,this.dostime >> 16 & 0x1F,this.dostime >> 11 & 0x1F,this.dostime >> 5 & 0x3F,(this.dostime & 0x1F) << 1);
         return _loc1_.time;
      }
      ...
      public function set time(param1:Number) : void
      {
         ...
         this.dostime = (_loc2_.fullYear - 1980 & 0x7F) << 25 | _loc2_.month + 1 << 21 | _loc2_.day << 16 | _loc2_.hours << 11 | _loc2_.minutes << 5 | _loc2_.seconds >> 1;
      }
