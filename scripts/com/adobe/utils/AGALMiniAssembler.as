package com.adobe.utils
{
   ...
   public class AGALMiniAssembler
   {
      ...
      private var _7380:ByteArray = null;
      
      private var _error:String = "";
      
      private var _7375:Boolean = false;
      ...
      public function get _7381() : ByteArray
      {
         return this._7380;
      }
      ...
      public function assemble(param1:String, param2:String, param3:uint = 1, param4:Boolean = false) : ByteArray
      {
         ...
         this._7381.endian = Endian.LITTLE_ENDIAN;
         this._7381.writeByte(160);
         this._7381.writeUnsignedInt(param3);
         this._7381.writeByte(161);
         this._7381.writeByte(_loc6_ ? 1 : 0);
         this._7377(param3,param4);
         ...
         while(_loc10_ < _loc11_ && this._error == "")
         {
            ...
            if((_loc13_ = int((_loc12_ = _loc12_.replace(REGEXP_OUTER_SPACES,"")).search("//"))) != -1)
            {
            ...
            else
            {
               ...
               else
               {
                  ...
                  this._7381.writeUnsignedInt(_loc17_.emitCode);
                  _loc9_++;
                  ...
                  while(_loc22_ < _loc21_)
                  {
                     ...
                     if(_loc31_)
                     {
                        this._7381.writeShort(_loc28_);
                        this._7381.writeByte(_loc29_);
                        this._7381.writeByte(_loc26_.emitCode);
                        _loc20_ -= 32;
                     }
                     else if(_loc32_)
                     {
                        ...
                        this._7381.writeShort(_loc28_);
                        this._7381.writeByte(int(_loc45_ * 8));
                        this._7381.writeByte(0);
                        this._7381.writeUnsignedInt(_loc43_);
                        if(this.verbose)
                        {
                        }
                        _loc20_ -= 64;
                     ...
                     else
                     {
                        if(_loc22_ == 0)
                        {
                           this._7381.writeUnsignedInt(0);
                           _loc20_ -= 32;
                        }
                        this._7381.writeShort(_loc28_);
                        this._7381.writeByte(_loc35_);
                        this._7381.writeByte(_loc29_);
                        this._7381.writeByte(_loc26_.emitCode);
                        this._7381.writeByte(_loc33_);
                        this._7381.writeShort(_loc23_ ? _loc34_ | 1 << 15 : 0);
                        _loc20_ -= 64;
                     }
                     _loc22_++;
                  }
         ...
         if(this._7375)
         {
            ...
            while(_loc49_ < _loc48_)
            {
               ...
               _loc50_ = this._7381[_loc49_].toString(16);
               if(_loc50_.length < 2)
               {
                  _loc50_ = "0" + _loc50_;
               }
      ...
      private function _7377(param1:uint, param2:Boolean) : void
      {
...
class OpCode
{
   private var _7379:uint;
   
   private var _7383:uint;
   
   private var _name:String;
   
   private var _7376:uint;
   ...
   {
      return "[OpCode name=\"" + this._name + "\", numRegister=" + this._7376 + ", emitCode=" + this._7379 + ", flags=" + this._7383 + "]";
   }
}
...
class Register
{
   ...
   private var _7378:String;
   
   private var _7383:uint;
   
   private var _7384:uint;
   ...
   public function toString() : String
   {
      return "[Register name=\"" + this._name + "\", longName=\"" + this._7378 + "\", emitCode=" + this._7379 + ", range=" + this._7384 + ", flags=" + this._7383 + "]";
   }
}

class Sampler
{
   private var _7386:uint;
   ...
   public function toString() : String
   {
      return "[Sampler name=\"" + this._name + "\", flag=\"" + this._7386 + "\", mask=" + this.mask + "]";
   }
}
