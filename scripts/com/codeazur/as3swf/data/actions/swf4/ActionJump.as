package com.codeazur.as3swf.data.actions.swf4
{
   ...
   public class ActionJump extends Action implements _14133
   {
      ...
      public function ActionJump(param1:uint, param2:uint, param3:uint)
      {
      ...
      {
         var _loc1_:ActionJump = new ActionJump(code,length,pos);
      ...
      override public function toString(param1:uint = 0) : String
      {
         ...
         _loc2_ += "]";
         return "[ActionJump] BranchOffset: " + this.branchOffset + _loc2_;
      }
      ...
      override public function _14979(param1:uint, param2:_14132) : String
      {
         ...
         return _14975(param1) + "jump " + _loc3_;
      }
   }
}
