package _813
{
   ...
   public class _814 extends Group
   {
      ...
      private const ICON_DROP:String = "/assets/comic/drop.png";
      ...
      public function _2894() : void
      {
         ...
         if(Boolean(this._6176) && this._6176.length == 1)
         {
            if(this._6176[0] is _79)
            {
               ...
               if(_loc1_._3107)
               {
                  this._6151(_loc1_._3107.tweens);
               }
               else
               {
                  this._6140();
            ...
            else if(this._6176[0] is _646)
            {
               ...
               if(_loc2_._3107)
               {
                  this._6151(_loc2_._3107.tweens);
               }
               else
               {
                  this._6140();
      ...
      private function _6151(param1:Vector.<_67>) : void
      {
         ...
         if(param1[0] is _60)
         {
            this._6145(param1[0] as _60);
         }
         else if(param1[0] is _59)
         {
            this._6152(param1[0] as _59);
         }
         else if(param1[0] is _61)
         {
            this._6154(param1[0] as _61);
         }
         else if(param1[0] is _10428)
         {
            this._10485(param1[0] as _10428);
         }
      }
      
      private function _6145(param1:_60) : void
      {
         this._6162();
         this._6171.text = tr("AppearProperty.postion");
         this._6170.source = this.ICON_POSTION;
      ...
      private function _6152(param1:_59) : void
      {
         this._6162();
         this._6171.text = tr("AppearProperty.alpha");
      ...
      private function _6154(param1:_61) : void
      {
         this._6162();
         this._6171.text = tr("AppearProperty.scale");
      ...
      private function _10485(param1:_10428) : void
      {
         this._6162();
         this._6171.text = tr("AppearProperty.drop");
         this._6170.source = this.ICON_DROP;
         this._4077.txt.text = param1.during.toFixed(2);
         this._6161.addElement(this.actionGroup);
         this._6161.addElement(this.line);
         this._6161.addElement(this._6163);
