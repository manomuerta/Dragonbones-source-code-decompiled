package _1373
{
   ...
   public class _787
   {
      protected static const rootSelectOffsetY:int = 20;
      
      public var _6005:Function;
      
      public var _6000:Function;
      
      public var _14011:Function;
      
      protected var _stage:Stage;
      
      protected var _6036:Tree;
      
      protected var _6032:Boolean = false;
      
      protected var _6018:Shape;
      
      protected var _6008:Shape;
      ...
      protected var _6029:Boolean = false;
      
      protected var _6028:_1046;
      
      protected var _6001:Boolean = false;
      
      protected var _6012:Boolean = false;
      
      protected var _3597:Array;
      
      protected var _6027:Boolean = false;
      
      protected var _6026:Stage;
      
      protected var _6017:Object;
      
      protected var _6016:Number = 0;
      
      protected var _6009:ItemRenderer;
      
      protected var _6019:Boolean = false;
      
      protected var _6034:Boolean = false;
      
      protected var _6020:Object;
      
      protected var _6030:Boolean = true;
      
      protected var _6021:Boolean = true;
      
      protected var _6010:Vector.<_1070>;
      
      public function _787()
      {
      ...
      protected function _6003(param1:Array) : Array
      {
      ...
      protected function _5991(param1:MouseEvent = null) : void
      {
         ...
         if(this._3597 != null && this._6027)
         {
            ...
            if(param1 != null)
            {
               this._6009 = param1.currentTarget as ItemRenderer;
            }
            if(!this._6009)
            {
               return;
      ...
      protected function _5989(param1:_1070) : Number
      {
      ...
      protected function _5997(param1:Object) : _1070
      {
         var _loc2_:int = 0;
      ...
      protected function _6015(param1:Object, param2:Array) : Boolean
      {
         var _loc3_:Boolean = false;
         var _loc4_:int = 0;
      ...
      protected function _6025(param1:Array, param2:Object) : void
      {
         var _loc4_:int = 0;
         var _loc3_:int = 0;
      ...
      protected function _2601(param1:RendererExistenceEvent) : void
      {
         ...
         {
            param1._2487.removeEventListener(MouseEvent.MOUSE_DOWN,this._5995);
            param1._2487.removeEventListener(MouseEvent.ROLL_OUT,this._5993);
            param1._2487.removeEventListener(MouseEvent.MOUSE_MOVE,this._5991);
            _loc2_ = 0;
            while(_loc2_ < this._6010.length)
            {
               if(this._6010[_loc2_] == ItemRenderer(param1._2487))
               {
                  _loc3_ = _loc2_;
      ...
      protected function _2603(param1:RendererExistenceEvent) : void
      {
         if(param1._2487 is ItemRenderer)
         {
            param1._2487.addEventListener(MouseEvent.MOUSE_DOWN,this._5995);
            param1._2487.addEventListener(MouseEvent.ROLL_OUT,this._5993);
            param1._2487.addEventListener(MouseEvent.MOUSE_MOVE,this._5991);
            this._6010.push(ItemRenderer(param1._2487));
         }
      }
      
      protected function _6013(param1:Object) : _1070
      {
         var _loc2_:_1070 = null;
         var _loc3_:int = 0;
      ...
      protected function _6007(param1:Array, param2:Object) : Boolean
      {
      ...
      protected function _6024(param1:_1070) : void
      {
      ...
      protected function _6014(param1:_1070, param2:Boolean = false) : void
      {
         var _loc3_:Point = null;
         var _loc4_:Point = null;
         if(param1 is TreeItemRenderer)
         {
            _loc3_ = TreeItemRenderer(param1)._2615.localToGlobal(new Point(TreeItemRenderer(param1)._2615.width,0));
            _loc3_ = this._6018.parent.globalToLocal(_loc3_);
            this._6018.graphics.beginFill(3762325);
            this._6018.graphics.drawRect(_loc3_.x,0,this._6036.width - _loc3_.x,2);
            this._6018.graphics.endFill();
            this._6018.visible = true;
            _loc4_ = DisplayObject(param1).localToGlobal(new Point(0,0));
            _loc4_ = this._6018.parent.globalToLocal(_loc4_);
            this._6018.x = _loc4_.x;
            if(param2)
            {
               this._6018.y = _loc4_.y - 1;
            }
            else
            {
               this._6018.y = _loc4_.y - 1 + this._5989(param1);
            }
            this._6028.ns_egret::_1607(this._6018);
         }
      }
