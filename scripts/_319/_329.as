package _319
{
   ...
   public class _329 extends _328
   {
      public function _329()
      {
         super();
         _2215 = true;
         _2219 = true;
      ...
      override public function execute() : void
      {
         ...
         while(_loc1_ < _loc2_)
         {
            mesh._3190(vertices[_loc1_],this._3192[_loc1_],this._3191[_loc1_]);
            _loc1_++;
         }
         vertex.update();
         this._2894();
      ...
      override public function revert() : void
      {
         ...
         while(_loc1_ < _loc2_)
         {
            mesh._3190(vertices[_loc1_],this._3147[_loc1_],this._3146[_loc1_]);
            _loc1_++;
         }
         vertex.update();
         this._2894();
      ...
      {
         var _loc2_:_329 = param1 as _329;
         if(_loc2_)
         {
