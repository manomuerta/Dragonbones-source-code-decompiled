package _14097
{
   ...
   public class _14098 extends _165
   {
      ...
      override public function set data(param1:Object) : void
      {
         ...
         else if(this.data is _693)
         {
            ...
            if(this.opened)
            {
               ...
               else if((this.data as _693)._4204 is _727)
               {
                  _5988 = SWF_OPEN;
               }
               else
         ...
         else if(this.data is _691)
         {
            ...
            else if((this.data as _691)._4204 is _726)
            {
               if((this.data as _691).count > 0)
               {
