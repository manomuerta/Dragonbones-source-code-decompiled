package _1011
{
   ...
   public class _12487 extends _171
   {
      ...
      public function _12487(param1:_720, param2:Function)
      {
      ...
      override protected function _2438() : void
      {
         ...
         if(this._7061)
         {
            if(this._7061.allAnimations)
            {
               ...
               {
                  (_loc12_ = new RadioButton()).label = this._7061.allAnimations[_loc10_];
                  _loc12_.group = this.radioGroup;
                  _loc12_.selected = this._7061.singleFrameAnimation == this._7061.allAnimations[_loc10_];
                  _loc3_.addElement(_loc12_);
                  this._12778.push(_loc12_);
                  _loc10_++;
               }
            }
         }
      ...
      private function _10893(param1:Event) : void
      {
         ...
         this._7061.singleFrameAnimation = _loc2_;
         this.refresh();
      }
