package _10259
{
   ...
   public class _10258 extends Group
   {
      ...
      private var _4761:_10244;
      
      public function _10258()
      {
         ...
         this.direction0 = tr("ActionPropertyGroup.directionHeart0");
         this.direction1 = tr("ActionPropertyGroup.directionHeart1");
      ...
      override protected function _2438() : void
      {
         ...
         this._10401.source = [this.direction0,this.direction1];
      ...
      public function set model(param1:_10244) : void
      {
         this._4761 = param1;
      ...
      private function _10395(param1:int) : int
      {
         ...
         switch(param1)
         {
            case _10244.INTENSITY_0:
               _loc2_ = 0;
               break;
            case _10244.INTENSITY_1:
               _loc2_ = 1;
               break;
            case _10244.INTENSITY_2:
               _loc2_ = 2;
               break;
            case _10244.INTENSITY_3:
               _loc2_ = 3;
         }
         return _loc2_;
      }
      ...
      {
         var _loc2_:int = _10244.SPEED_2;
         switch(param1)
         {
            case 0:
               _loc2_ = _10244.SPEED_0;
               break;
            case 1:
               _loc2_ = _10244.SPEED_1;
               break;
            case 2:
               _loc2_ = _10244.SPEED_2;
               break;
            case 3:
               _loc2_ = _10244.SPEED_3;
               break;
            case 4:
               _loc2_ = _10244.SPEED_4;
         }
         return _loc2_;
      }
      ...
      {
         var _loc2_:int = _10244.INTENSITY_2;
         switch(param1)
         {
            case 0:
               _loc2_ = _10244.INTENSITY_0;
               break;
            case 1:
               _loc2_ = _10244.INTENSITY_1;
               break;
            case 2:
               _loc2_ = _10244.INTENSITY_2;
               break;
            case 3:
               _loc2_ = _10244.INTENSITY_3;
         }
         return _loc2_;
      }
   }
