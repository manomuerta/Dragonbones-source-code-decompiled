package _10259
{
   ...
   public class _10434 extends Group
   {
      ...
      private var _4761:_10430;
      
      public function _10434()
      {
      ...
      public function set model(param1:_10430) : void
      {
         this._4761 = param1;
      ...
      {
         var _loc2_:int = _10430.SPEED_2;
         switch(param1)
         {
            case 0:
               _loc2_ = _10430.SPEED_0;
               break;
            case 1:
               _loc2_ = _10430.SPEED_1;
               break;
            case 2:
               _loc2_ = _10430.SPEED_2;
               break;
            case 3:
               _loc2_ = _10430.SPEED_3;
               break;
            case 4:
               _loc2_ = _10430.SPEED_4;
         }
         return _loc2_;
      }
   }
