package _10259
{
   ...
   public class _10261 extends Group
   {
      ...
      private var _4761:_10246;
      
      public function _10261()
      {
      ...
      override protected function _2438() : void
      {
         ...
         this._10408.source = [this.speed0,this.speed1,this.speed2,this.speed3];
      ...
      public function set model(param1:_10246) : void
      {
         this._4761 = param1;
      ...
      private function _10395(param1:int) : int
      {
         ...
         switch(param1)
         {
            case _10246.INTENSITY_0:
               _loc2_ = 0;
               break;
            case _10246.INTENSITY_1:
               _loc2_ = 1;
               break;
            case _10246.INTENSITY_2:
               _loc2_ = 2;
               break;
            case _10246.INTENSITY_3:
               _loc2_ = 3;
         }
         return _loc2_;
      }
      ...
      {
         var _loc2_:int = _10246.SPEED_2;
         switch(param1)
         {
            case 0:
               _loc2_ = _10246.SPEED_0;
               break;
            case 1:
               _loc2_ = _10246.SPEED_1;
               break;
            case 2:
               _loc2_ = _10246.SPEED_2;
               break;
            case 3:
               _loc2_ = _10246.SPEED_3;
         }
         return _loc2_;
      }
      ...
      {
         var _loc2_:int = _10246.INTENSITY_3;
         switch(param1)
         {
            case 0:
               _loc2_ = _10246.INTENSITY_0;
               break;
            case 1:
               _loc2_ = _10246.INTENSITY_1;
               break;
            case 2:
               _loc2_ = _10246.INTENSITY_2;
               break;
            case 3:
               _loc2_ = _10246.INTENSITY_3;
         }
         return _loc2_;
      }
   }
