package _273
{
   ...
   public class _10250 extends _92
   {
      public function _10250()
      {
         super();
         _2219 = true;
         _2215 = true;
      ...
      override public function _1572(param1:*) : void
      {
         ...
         {
            _2223.oldValue.push(_loc2_.during);
         }
      }
      
      override public function merge(param1:IAction) : Boolean
      {
         var _loc2_:_10250 = param1 as _10250;
      ...
      override public function execute() : void
      {
         ...
         {
            _loc1_.during = this.newValue as Number;
         }
         this._2894();
      }
      ...
      override public function revert() : void
      {
         ...
         while(_loc1_ < this.tweens.length)
         {
            ...
            _loc2_.during = this.oldValue[_loc1_];
            _loc1_++;
         }
         this._2894();
      }
