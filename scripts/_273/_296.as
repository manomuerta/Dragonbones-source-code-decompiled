package _273
{
   ...
   public class _296 extends _92
   {
      public function _296()
      {
         super();
         _2219 = true;
         _2215 = true;
      ...
      {
         super._1572(param1);
         _2223.oldValue = this._2071.easing;
      }
      
      override public function merge(param1:IAction) : Boolean
      {
         var _loc2_:_296 = param1 as _296;
      ...
      {
         super.execute();
         this._2071.easing = this.newValue as int;
         this._2894();
      }
      ...
      {
         super.revert();
         this._2071.easing = this.oldValue as int;
         this._2894();
      }
