package _1185
{
   ...
   public class _1197 extends _1192
   {
      private static var _8956:Dictionary = new Dictionary(true);
      ...
      private function _8926() : void
      {
         ...
         var _loc4_:Number = Math.max(this._8944,_loc3_);
         var _loc5_:Number = this._8918();
         ...
         for each(_loc7_ in _loc6_)
         {
            ...
            if(!(_loc15_ == null || !_loc15_.includeInLayout))
            {
               ...
               _loc5_ += _loc17_;
               _loc5_ = _loc5_ += _loc17_ - (isNaN(this._8920[_loc7_]) ? _loc2_ : this._8920[_loc7_]);
               _loc4_ = Math.max(_loc4_,_loc16_);
            }
         }
         ...
         if(!_1141._8325(this))
         {
            target._7983 = this._2401 == _1188.JUSTIFY ? _loc13_ : target.measuredWidth;
            target._7980 = Math.ceil(target.measuredHeight);
         }
      }
      ...
      private function _8930() : void
      {
         ...
         var _loc2_:* = this._2401 == _1188.JUSTIFY;
         ...
         while(_loc7_ < _loc3_)
         {
            ...
            {
               this._8924(_loc18_,_loc2_,_loc1_);
               _loc19_ = _loc1_.preferredSize;
               _loc5_ = Math.max(_loc5_,_loc19_);
               _loc17_ = Math.max(_loc17_,_loc1_.minSize);
               this._8922(_loc18_,NaN,_loc1_);
               _loc20_ = _loc1_.preferredSize;
               _loc6_ += _loc20_;
               _loc16_ += _loc1_.minSize;
            }
            _loc7_++;
         }
         var _loc8_:Number = isNaN(this._7007) ? 0 : this._7007;
         _loc6_ += (_loc4_ - 1) * _loc8_;
         if(!_1141._8325(this))
         {
            _loc16_ += (_loc4_ - 1) * _loc8_;
         }
      ...
      override public function _8090(param1:int, param2:uint) : int
      {
         ...
         switch(param2)
         {
            ...
            case _1137.DOWN:
               ...
               break;
            case _1137.PAGE_UP:
               _loc7_ = this._8931(target.scrollRect.top,0,target._2249 - 1);
               _loc8_ = this._8931(target.scrollRect.bottom,0,target._2249 - 1);
               _loc9_ = _loc7_;
               ...
               else
               {
                  ...
                  {
                     _loc6_ = _7625(_1137.PAGE_UP) + _8929().top;
                  }
                  else
                  {
                     _loc6_ = this._7988(param1).bottom - _8929().height;
                  }
                  _loc4_ = param1 - 1;
                  while(0 <= _loc4_)
                  {
                     _loc5_ = this._7988(_loc4_);
                     if((Boolean(_loc5_)) && _loc5_.top < _loc6_)
                     {
            ...
            case _1137.PAGE_DOWN:
               _loc7_ = this._8931(target.scrollRect.top,0,target._2249 - 1);
               _loc10_ = _loc8_ = this._8931(target.scrollRect.bottom,0,target._2249 - 1);
               ...
               else
               {
                  ...
                  {
                     _loc6_ = _7625(_1137.PAGE_DOWN) + _8929().bottom;
                  }
                  else
                  {
                     _loc6_ = this._7988(param1).top + _8929().height;
                  }
                  _loc4_ = param1 + 1;
                  while(_loc4_ <= _loc3_)
                  {
                     _loc5_ = this._7988(_loc4_);
                     if((Boolean(_loc5_)) && _loc5_.bottom > _loc6_)
                     {
      ...
      public function _8915(param1:int) : Number
      {
         ...
         else
         {
            ...
            _loc3_ = _loc9_.layoutBoundsY;
            _loc4_ = _loc9_.layoutBoundsHeight;
         }
         var _loc5_:Number = _loc2_.verticalScrollPosition;
         var _loc6_:Number = _loc5_ + _loc2_.height;
      ...
      private function _8923(param1:int) : Number
      {
         ...
         if(!_6056)
         {
            ...
            return !!_loc8_ ? _loc8_.y : _loc3_;
         }
         var _loc5_:Number = !!_7607 ? _7607.height : 22;
      ...
      private function _8925(param1:int) : Number
      {
         ...
         if(_6056)
         {
            ...
            if(isNaN(_loc2_))
            {
               _loc2_ = !!_7607 ? _7607.height : 22;
            }
            return _loc2_;
         }
         if(target)
         {
            return target.getElementAt(param1).height;
         }
         return 0;
      }
      ...
      {
         var _loc6_:Number = NaN;
         var _loc1_:Number = isNaN(this._7007) ? 0 : this._7007;
         var _loc2_:Number = !!_7607 ? _7607.height : 22;
         var _loc3_:Number = 0;
      ...
      protected function _8931(param1:Number, param2:int, param3:int) : int
      {
      ...
      private function _8927() : Boolean
      {
         ...
         var _loc2_:Number = isNaN(this._8024) ? _loc1_ : this._8024;
         var _loc3_:Number = isNaN(this._8021) ? _loc1_ : this._8021;
         var _loc4_:int = target._2249;
         var _loc5_:Number = this._8923(_loc4_ - 1) + this._8920[_loc4_ - 1] + _loc3_;
         var _loc6_:Number = target.verticalScrollPosition;
         if(_loc6_ > _loc5_ - _loc3_)
         {
            this.startIndex = -1;
            this.endIndex = -1;
            return false;
         }
         var _loc7_:Number = target.verticalScrollPosition + target.height;
         if(_loc7_ < _loc2_)
         {
            this.startIndex = -1;
            this.endIndex = -1;
         ...
         var _loc8_:int = this.startIndex;
         var _loc9_:int = this.endIndex;
         this.startIndex = this._8931(_loc6_,0,_loc4_ - 1);
         if(this.startIndex == -1)
         {
            this.startIndex = 0;
         }
         this.endIndex = this._8931(_loc7_,0,_loc4_ - 1);
         if(this.endIndex == -1)
         {
            this.endIndex = _loc4_ - 1;
         }
         return _loc8_ != this.startIndex || _loc9_ != this.endIndex;
      }
      ...
      private function _8914(param1:Number, param2:Number) : void
      {
         ...
         {
            _loc8_ = this._8923(_loc9_) - _loc7_ + _loc6_;
            target._7729(target.contentWidth,Math.ceil(_loc8_));
            return;
         }
         target._7577(this.startIndex,this.endIndex);
         var _loc10_:Boolean = this._8919 == _1188.JUSTIFY || this._8919 == _1188.CONTENT_JUSTIFY;
         var _loc11_:* = this._8919 == _1188.CONTENT_JUSTIFY;
         ...
         if(_loc11_)
         {
            ...
            while(_loc25_ <= this.endIndex)
            {
               ...
               {
                  this._8944 = Math.max(this._8944,_loc15_.preferredWidth);
               }
               _loc25_++;
            }
            _loc14_ = Math.ceil(Math.max(_loc13_,this._8944));
         }
         ...
         while(_loc24_ <= this.endIndex)
         {
            ...
            if(_loc15_)
            {
               ...
               else
               {
                  ...
                  {
                     _loc19_ = _loc4_;
                     _loc15_._7599(_loc14_,NaN);
                  }
                  else
                  {
                     _loc26_ = (_loc13_ - _loc15_.layoutBoundsWidth) * _loc12_;
                     _loc26_ = _loc26_ > 0 ? _loc26_ : 0;
                     _loc19_ = _loc4_ + _loc26_;
                  }
                  if(!_loc11_)
                  {
                     this._8944 = Math.max(this._8944,_loc15_.preferredWidth);
                  }
                  _loc21_ = Math.max(_loc21_,_loc15_.layoutBoundsWidth);
                  if(!_loc23_)
                  {
                     _loc22_ = isNaN(this._8920[_loc24_]) ? _loc16_ : Number(this._8920[_loc24_]);
                     if(_loc22_ != _loc15_.layoutBoundsHeight)
                     {
                        _loc23_ = true;
                     }
                  }
                  if(_loc24_ == 0 && this._8920.length > 0 && this._8920[_loc24_] != _loc15_.layoutBoundsHeight)
                  {
                     _7607 = null;
                  }
                  this._8920[_loc24_] = _loc15_.layoutBoundsHeight;
                  _loc20_ = this._8923(_loc24_);
                  _loc15_._7777(Math.round(_loc19_),Math.round(_loc20_));
               }
            }
            _loc24_++;
         }
         _loc21_ += _loc4_ + _loc5_;
         _loc8_ = this._8923(_loc9_) - _loc7_ + _loc6_;
         target._7729(Math.ceil(_loc21_),Math.ceil(_loc8_));
         if(_loc23_ || _loc18_ < this._8944)
         {
            target.invalidateSize();
         }
      }
      ...
      private function _8917(param1:Number, param2:Number) : void
      {
         ...
         var _loc11_:* = this._7650 == _1196.JUSTIFY;
         var _loc12_:Boolean = this._8919 == _1188.JUSTIFY || this._8919 == _1188.CONTENT_JUSTIFY;
         ...
         while(_loc18_ < _loc14_)
         {
            ...
            {
               this._8944 = Math.max(this._8944,_loc19_.preferredWidth);
               if(_loc11_)
               {
                  _loc20_ += _loc19_.preferredHeight;
               }
               else if(!isNaN(_loc19_.percentHeight))
               {
                  _loc21_ += _loc19_.percentHeight;
                  (_loc23_ = new ChildInfo()).layoutElement = _loc19_;
                  _loc23_.percent = _loc19_.percentHeight;
                  if(_1141._8325(this))
                  {
                     _loc23_.min = _loc19_.minHeight;
                     _loc23_.max = _loc19_.maxHeight;
                  }
                  else
                  {
                     _loc23_.min = _loc19_._8487();
                     _loc23_.max = _loc19_._8505();
                  }
                  _loc22_.push(_loc23_);
               }
               else
               {
                  _loc24_ -= _loc19_.preferredHeight;
               }
            }
            _loc18_++;
         }
         _loc24_ -= (_loc15_ - 1) * _loc8_;
         _loc24_ = _loc24_ -= (_loc15_ - 1) * _loc8_ > 0 ? _loc24_ : 0;
         var _loc25_:Number = _loc10_ - _loc20_ - _loc8_ * (_loc15_ - 1);
         var _loc27_:int = _loc15_;
         var _loc28_:Dictionary = _8956;
         if(_loc11_)
         {
            if(_loc25_ < 0)
            {
               ...
               while(_loc18_ < _loc14_)
               {
                  ...
                  if(!(!_loc19_ || !_loc19_.includeInLayout))
                  {
                     _loc36_ = _loc19_.preferredHeight;
                     if(_loc36_ <= _loc26_)
                     {
                        _loc24_ -= _loc36_;
                        _loc27_--;
         ...
         {
            _8913(_loc10_,_loc24_,_loc21_,_loc22_);
            _loc37_ = 0;
         ...
         {
            _loc17_ = _loc6_ + _loc24_ * 0.5;
         }
         else if(this._7650 == _1196.BOTTOM)
         {
            _loc17_ = _loc6_ + _loc24_;
         }
         var _loc29_:Number = _loc4_;
         var _loc30_:Number = _loc6_;
         var _loc31_:Number = 0;
         var _loc32_:Number = 0;
         var _loc33_:Number = Math.ceil(_loc9_);
         if(this._8919 == _1188.CONTENT_JUSTIFY)
         {
            _loc33_ = Math.ceil(Math.max(_loc9_,this._8944));
         }
         _loc37_ = 0;
         ...
         while(_loc18_ < _loc14_)
         {
            ...
            if(!(!_loc19_ || !_loc19_.includeInLayout))
            {
               ...
               if(_loc11_)
               {
                  ...
                  if(_loc25_ > 0)
                  {
                     _loc35_ = _loc24_ * _loc19_.preferredHeight / _loc20_;
                  }
                  else if(_loc25_ < 0 && _loc19_.preferredHeight > _loc26_)
                  {
               ...
               {
                  _loc16_ = _loc4_;
                  _loc19_._7599(_loc33_,_loc34_);
               }
               else
               {
                  _loc40_ = NaN;
                  if(!isNaN(_loc19_.percentWidth))
                  {
                     _loc41_ = Math.min(100,_loc19_.percentWidth);
                     _loc40_ = Math.round(_loc9_ * _loc41_ * 0.01);
                  }
                  _loc19_._7599(_loc40_,_loc34_);
                  _loc39_ = (_loc9_ - _loc19_.layoutBoundsWidth) * _loc13_;
                  _loc39_ = _loc39_ > 0 ? _loc39_ : 0;
                  _loc16_ = _loc4_ + _loc39_;
               }
      ...
      override public function _7988(param1:int) : Rectangle
      {
         ...
         var _loc4_:Number = !!_7607 ? _7607.width : 71;
         _loc3_.x = 0;
         _loc3_.width = _loc4_;
         _loc3_.top = this._8923(param1);
         _loc3_.bottom = this._8925(param1) + _loc3_.top;
         return _loc3_;
      }
      ...
      override protected function _7926(param1:Rectangle) : Rectangle
      {
         ...
         var _loc3_:int = this._8931(param1.top,0,target._2249 - 1);
         var _loc4_:Number = isNaN(this._padding) ? 0 : this._padding;
         var _loc5_:Number = isNaN(this._8024) ? _loc4_ : this._8024;
         var _loc6_:Number = isNaN(this._8021) ? _loc4_ : this._8021;
         if(_loc3_ == -1)
         {
            if(param1.top > target.contentHeight - _loc6_)
            {
               _loc2_.top = target.contentHeight - _loc6_;
               _loc2_.bottom = target.contentHeight;
            }
            else
            {
               _loc2_.top = 0;
               _loc2_.bottom = _loc5_;
            }
            return _loc2_;
         }
         _loc2_.top = this._8923(_loc3_);
         _loc2_.bottom = this._8925(_loc3_) + _loc2_.top;
      ...
      override protected function _7925(param1:Rectangle) : Rectangle
      {
         ...
         var _loc3_:int = target._2249;
         var _loc4_:int = this._8931(param1.bottom,0,_loc3_ - 1);
         var _loc5_:Number = isNaN(this._padding) ? 0 : this._padding;
         var _loc6_:Number = isNaN(this._8024) ? _loc5_ : this._8024;
         var _loc7_:Number = isNaN(this._8021) ? _loc5_ : this._8021;
         if(_loc4_ == -1)
         {
            if(param1.right < _loc6_)
            {
               _loc2_.top = 0;
               _loc2_.bottom = _loc6_;
            }
            else
            {
               _loc2_.top = target.contentHeight - _loc7_;
               _loc2_.bottom = target.contentHeight;
            }
            return _loc2_;
         }
         _loc2_.top = this._8923(_loc4_);
         _loc2_.bottom = this._8925(_loc4_) + _loc2_.top;
      ...
      private function _8924(param1:_1122, param2:Boolean, param3:SizesAndLimit) : void
      {
         var _loc4_:Number = Math.ceil(param1.preferredWidth);
      ...
      private function _8922(param1:_1122, param2:Number, param3:SizesAndLimit) : void
      {
         var _loc4_:Number = isNaN(param2) ? Math.ceil(param1.preferredHeight) : param2;
